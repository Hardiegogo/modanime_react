      ...
      <div className="hero grid-2">
        <div className="hero-left">
          <div className="hero-left-content">
            <h1>
              One place <br /> for all your <br />{" "}
              <span className="prime-heading">Anime</span>-wishes.
            </h1>
            <Link
              to="/products"
              className="btn-large btn-primary btn-hero mt-24 medium-text"
            >
              Go to products
            </Link>
          </div>
        ...
        <div className="hero-right">
          <img
            src="https://res.cloudinary.com/dqqehaaqo/image/upload/v1647734809/hello_o63naq.png"
            className="resp-img"
            alt=""
          />
        </div>
